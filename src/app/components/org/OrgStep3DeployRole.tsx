...
import { OrgFormData, ORG_STEPS, AUTO_GENERATED } from "../../types";
...
export function OrgStep3DeployRole({
  formData,
  onUpdate,
  onNext,
  onBack,
  ...
  return (
    <div className="flex flex-col flex-1 bg-white min-h-0">
      <Stepper steps={ORG_STEPS} currentStep={2} />

      <div className="flex-1 overflow-y-auto px-8 py-7">
        <div className="max-w-xl">
          <h2 className="text-[#1E293B] mb-1">Deploy IAM Role</h2>
          <p className="text-sm text-[#64748B] mb-6">
            Deploy the AccuKnox cross-account IAM role via CloudFormation StackSet across your
            organization.
          </p>
          ...
          <div className="flex items-start gap-3 bg-[#FFFBEB] border border-[#FCD34D] border-l-4 border-l-[#F59E0B] rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-[#92400E]">
              ...
              is logged in with your Management Account before proceeding with this step.
            </p>
          </div>
          ...
          <div className="mb-2">
            ...
            <p className="text-xs text-[#64748B] mt-2 text-center">
              Opens AWS Quick Create Stack — template URL, role name, and External ID are
              pre-filled. This deploys as a StackSet across your org.
            </p>
          </div>
