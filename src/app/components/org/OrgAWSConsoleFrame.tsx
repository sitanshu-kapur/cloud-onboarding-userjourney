...
interface OrgAWSConsoleFrameProps {
  accountId: string;
  onCreateStack: () => void;
  onBack: () => void;
}
...
export function OrgAWSConsoleFrame({
  accountId,
  onCreateStack,
  onBack,
}: OrgAWSConsoleFrameProps) {
      ...
      <div className="flex flex-1">
        <div className="flex-1 px-8 py-6 max-w-4xl">
          ...
          <p className="text-sm text-[#546E7A] mb-6">
            ...
            <strong>Create stack</strong>. This will deploy a StackSet across your AWS Organization.
          </p>

          {/* Template section */}
          <div className="mb-6">
            <h3 className="text-[#16191F] text-base font-semibold mb-3">Template</h3>
          ...
          <div className="mb-8">
            ...
            <div className="bg-[#FEF9E7] border border-[#F9CA24] rounded p-4 mb-4">
              <p className="text-sm text-[#7D6608]">
                ...
                <code className="text-xs bg-[#FCF3CF] px-1 py-0.5 rounded">
          ...
          {stackCreated && (
            <div className="mt-4 flex items-center gap-2 text-sm text-[#1D8348]">
              <span className="inline-flex w-4 h-4 rounded-full bg-[#1D8348] text-white items-center justify-center text-xs">
                ✓
              </span>
        ...
        <div className="w-72 border-l border-[#E2E2E2] px-6 py-6 shrink-0">
          ...
          <p className="text-xs text-[#546E7A] leading-relaxed mb-4">
            ...
            resources for security analysis via STS AssumeRole. It is deployed as a StackSet across
