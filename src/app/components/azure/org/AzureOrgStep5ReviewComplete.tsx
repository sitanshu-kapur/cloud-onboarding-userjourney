...
export function AzureOrgStep5ReviewComplete({ formData, onBack, onCancel, onComplete }: Props) {
  ...
  const scopeDisplay =
    formData.scope === "all"
      ? `Sync all subscriptions (Root MG: ${formData.rootManagementGroupId})`
  ...
  return (
    <div className="flex flex-col flex-1 bg-white min-h-0">
      <Stepper steps={AZURE_ORG_STEPS} currentStep={4} />
      ...
      <div className="flex-1 overflow-y-auto px-8 py-7">
        <div className="max-w-xl">
          ...
          <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-6 mb-6">
            ...
            <div className="mb-5">
              ...
              <div className="bg-white rounded-lg border border-[#E2E8F0] px-4">
                <ReviewRow label="AccuKnox Managing Tenant ID" value={AZURE_AUTO_GENERATED.accuknoxTenantId} />
                <ReviewRow label="Verification Token" value={AZURE_AUTO_GENERATED.verificationToken} />
                <ReviewRow label="Auth Method" value="Azure Lighthouse Delegated Access" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-white rounded-lg border border-[#E2E8F0] px-4">
                ...
                <ReviewRow label="Subscription Sync" value={formData.autoSyncSubscriptions ? "Automatic" : "Manual"} />
          ...
          <div className="flex items-start gap-3 bg-[#F0FDF4] border border-[#86EFAC] border-l-4 border-l-[#16A34A] rounded-lg p-4 mb-2">
            ...
            <div>
              <p className="text-sm text-[#166534] font-medium">Lighthouse delegation verified</p>
              <p className="text-sm text-[#15803D] mt-0.5">
                AccuKnox successfully confirmed delegated access to your Azure organization. Subscription
          ...
          <div className="flex items-start gap-2.5 mt-5 p-4 bg-[#EFF6FF] border border-[#BFDBFE] rounded-lg">
            ...
            <p className="text-xs text-[#004578] leading-relaxed">
              AccuKnox will begin scanning your Azure organization within a few minutes. New
              subscriptions will be automatically enrolled as they are added to your tenant.
            </p>
          </div>
        </div>
      </div>
